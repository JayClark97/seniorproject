...
namespace seniorproject
    ...
    class Model
        ...
        public:
            ...
            unsigned                    getGammaNCateg() const;
            std::vector<double>         getExchangeabilities() const;
            std::vector<double>         getStateFreqs() const;
            std::vector<double>         getDiscreteGammaRelRates() const;
            std::vector<double>         getDiscreteGammaCategBoundaries() const;
            std::vector<double>         getDiscreteGammaRateProbs() const;
...
inline std::string Model::describeModel() const
    {
    std::string s;
    s += "\n----------------- Model Info ------------------\n";
...
inline double Model::getGammaShape() const
    {
    return _gamma_shape;
    }

inline unsigned Model::getGammaNCateg() const
    {
    return _num_categ;
    }

inline std::vector<double> Model::getExchangeabilities() const
    {
    return _exchangeabilities;
    }

inline std::vector<double> Model::getStateFreqs() const
    {
    return _state_freqs;
    }

inline std::vector<double> Model::getDiscreteGammaRelRates() const
    {
    return _relative_rates;
    }

inline std::vector<double> Model::getDiscreteGammaCategBoundaries() const
    {
    return _categ_boundaries;
    }

inline std::vector<double> Model::getDiscreteGammaRateProbs() const
    {
    return _rate_probs;
    }
...
inline void Model::setExchangeabilities(const std::vector<double> & exchangeabilities)
    {
    _exchangeabilities.assign(exchangeabilities.begin(), exchangeabilities.end());
    recalcRateMatrix();
    }

inline void Model::setStateFreqs(const std::vector<double> & state_frequencies)
    {
...
inline void Model::setExchangeabilitiesAndStateFreqs(const std::vector<double> & exchangeabilities, const std::vector<double> & state_frequencies)
    {
    _exchangeabilities.assign(exchangeabilities.begin(), exchangeabilities.end());
...
inline void Model::useStoredData(bool using_data)
    {
    _using_data = using_data;
    }

inline void Model::recalcRateMatrix()
    {
    if (_using_data)
        {
...
inline void Model::recalcGammaRates()
    {
    assert(_num_categ > 0);
...
inline int Model::setBeagleEigenDecomposition(int beagle_instance)
    {
...
inline int Model::setBeagleStateFrequencies(int beagle_instance)
    {
...
inline int Model::setBeagleAmongSiteRateVariationRates(int beagle_instance)
    {
...
inline int Model::setBeagleAmongSiteRateVariationProbs(int beagle_instance)
    {
